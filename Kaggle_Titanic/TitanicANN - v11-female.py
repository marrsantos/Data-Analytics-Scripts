...
dftrain = dftrain[dftrain.Sex=='female']
dfreal = dfreal[dfreal.Sex=='female']
...
y_predreal = np.where(y_predreal > 0.6,1,0)
...
dfresults.to_csv(data_folder+'resultsPYfemale.csv',index=False)
