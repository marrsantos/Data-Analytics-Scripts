...
# Keeping only variables with higher correlation to Survived
...
def build_classifier(Optimizer, Units):
    classifier = Sequential()
    classifier.add(Dense(units = Units, kernel_initializer = 'uniform', activation = 'relu', input_dim = 152))
...
# Parameters:
# 0.7589 adam, units=101, batch_size=32, nb_epoch=50
# Pclass, Sex, Ticket, Fare, Cabin
